...
uav_msgs__msg__ChargeRequest__init(uav_msgs__msg__ChargeRequest * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->uav_id)) {
    uav_msgs__msg__ChargeRequest__fini(msg);
    return false;
  }
  // role
  // battery_level
...
uav_msgs__msg__ChargeRequest__create()
{
  ...
  uav_msgs__msg__ChargeRequest * msg = (uav_msgs__msg__ChargeRequest *)allocator.allocate(sizeof(uav_msgs__msg__ChargeRequest), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(uav_msgs__msg__ChargeRequest));
  bool success = uav_msgs__msg__ChargeRequest__init(msg);
  if (!success) {
...
uav_msgs__msg__ChargeRequest__Sequence__init(uav_msgs__msg__ChargeRequest__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  uav_msgs__msg__ChargeRequest * data = NULL;

  if (size) {
    data = (uav_msgs__msg__ChargeRequest *)allocator.zero_allocate(size, sizeof(uav_msgs__msg__ChargeRequest), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = uav_msgs__msg__ChargeRequest__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        uav_msgs__msg__ChargeRequest__fini(&data[i - 1]);
      }
...
uav_msgs__msg__ChargeRequest__Sequence__fini(uav_msgs__msg__ChargeRequest__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      uav_msgs__msg__ChargeRequest__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  uav_msgs__msg__ChargeRequest__Sequence * array = (uav_msgs__msg__ChargeRequest__Sequence *)allocator.allocate(sizeof(uav_msgs__msg__ChargeRequest__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = uav_msgs__msg__ChargeRequest__Sequence__init(array, size);
  if (!success) {
...
uav_msgs__msg__ChargeRequest__Sequence__destroy(uav_msgs__msg__ChargeRequest__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    uav_msgs__msg__ChargeRequest__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
uav_msgs__msg__ChargeRequest__Sequence__are_equal(const uav_msgs__msg__ChargeRequest__Sequence * lhs, const uav_msgs__msg__ChargeRequest__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!uav_msgs__msg__ChargeRequest__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  uav_msgs__msg__ChargeRequest__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(uav_msgs__msg__ChargeRequest);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    uav_msgs__msg__ChargeRequest * data =
      (uav_msgs__msg__ChargeRequest *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!uav_msgs__msg__ChargeRequest__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          uav_msgs__msg__ChargeRequest__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!uav_msgs__msg__ChargeRequest__copy(
