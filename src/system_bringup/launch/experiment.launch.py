...
def _make_nodes(context, *args, **kwargs):
    ...
    ugv_params = {
        ...
        "active_session_status_stale_sec": float(_get(cfg, ["ugv", "active_session_status_stale_sec"], 8.0)),
        "active_session_no_progress_sec": float(_get(cfg, ["ugv", "active_session_no_progress_sec"], 20.0)),
        "active_session_stale_confirm_cycles": int(_get(cfg, ["ugv", "active_session_stale_confirm_cycles"], 3)),
        "active_session_no_progress_confirm_cycles": int(_get(cfg, ["ugv", "active_session_no_progress_confirm_cycles"], 3)),
    ...
    shared_uav_params = {
        ...
        "task_telemetry_requires_ack": bool(task_tlm.get("requires_ack", True)),
        "task_telemetry_ack_retry_sec": float(task_tlm.get("ack_retry_sec", 1.0)),
        "task_telemetry_ack_max_retries": int(task_tlm.get("ack_max_retries", 8)),
        "telemetry_ack_wait_timeout_sec": float(task_tlm.get("ack_wait_timeout_sec", 20.0)),
