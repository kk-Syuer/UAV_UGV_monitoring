...
#include "uav_msgs/msg/detail/uav_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const uav_msgs::msg::UavStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uav_msgs::msg::UavStatus *>(
    untyped_ros_message);
...
{
  return &uav_msgs::msg::typesupport_fastrtps_cpp::_UavStatus__handle;
}
