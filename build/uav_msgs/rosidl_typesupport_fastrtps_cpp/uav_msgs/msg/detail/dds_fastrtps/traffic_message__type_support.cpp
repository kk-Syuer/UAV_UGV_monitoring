...
#include "uav_msgs/msg/detail/traffic_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uav_msgs::msg::TrafficMessage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uav_msgs::msg::TrafficMessage & ros_message)
{
  // Member: msg_id
  cdr >> ros_message.msg_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_uav_msgs
max_serialized_size_TrafficMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const uav_msgs::msg::TrafficMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uav_msgs::msg::TrafficMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrafficMessage__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const uav_msgs::msg::TrafficMessage *>(
...
static size_t _TrafficMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrafficMessage(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrafficMessage__callbacks = {
  "uav_msgs::msg",
  "TrafficMessage",
...
static rosidl_message_type_support_t _TrafficMessage__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrafficMessage__callbacks,
...
{
  return &uav_msgs::msg::typesupport_fastrtps_cpp::_TrafficMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uav_msgs, msg, TrafficMessage)() {
  return &uav_msgs::msg::typesupport_fastrtps_cpp::_TrafficMessage__handle;
}
