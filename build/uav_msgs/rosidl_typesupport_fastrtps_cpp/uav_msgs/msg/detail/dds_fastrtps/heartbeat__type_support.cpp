...
#include "uav_msgs/msg/detail/heartbeat__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uav_msgs::msg::Heartbeat & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uav_msgs::msg::Heartbeat & ros_message)
{
  // Member: uav_id
  cdr >> ros_message.uav_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uav_msgs::msg::Heartbeat;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const uav_msgs::msg::Heartbeat *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uav_msgs::msg::Heartbeat *>(
    untyped_ros_message);
...
{
  return &uav_msgs::msg::typesupport_fastrtps_cpp::_Heartbeat__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uav_msgs, msg, Heartbeat)() {
  return &uav_msgs::msg::typesupport_fastrtps_cpp::_Heartbeat__handle;
}
