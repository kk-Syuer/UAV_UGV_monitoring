...
static const _ChargeDecision_type_support_symbol_names_t _ChargeDecision_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uav_msgs, msg, ChargeDecision)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uav_msgs, msg, ChargeDecision)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, uav_msgs, msg, ChargeDecision)() {
  return &::uav_msgs::msg::rosidl_typesupport_c::ChargeDecision_message_type_support_handle;
}
