...
bool uav_msgs__msg__uav_deployment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uav_msgs.msg._uav_deployment.UavDeployment", full_classname_dest, 42) == 0);
  }
  uav_msgs__msg__UavDeployment * ros_message = _ros_message;
  {  // uav_id
...
{
  /* NOTE(esteve): Call constructor of UavDeployment */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("uav_msgs.msg._uav_deployment");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UavDeployment");
