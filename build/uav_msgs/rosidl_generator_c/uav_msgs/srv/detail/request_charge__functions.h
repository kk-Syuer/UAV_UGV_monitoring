...
#ifndef UAV_MSGS__SRV__DETAIL__REQUEST_CHARGE__FUNCTIONS_H_
#define UAV_MSGS__SRV__DETAIL__REQUEST_CHARGE__FUNCTIONS_H_
...
/// Initialize srv/RequestCharge message.
/**
...
/// Finalize srv/RequestCharge message.
/**
...
/// Create srv/RequestCharge message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * uav_msgs__srv__RequestCharge_Request__init().
...
/// Destroy srv/RequestCharge message.
/**
 * It calls
 * uav_msgs__srv__RequestCharge_Request__fini()
...
/// Check for srv/RequestCharge message equality.
/**
...
/// Copy a srv/RequestCharge message.
/**
...
/// Initialize array of srv/RequestCharge messages.
/**
...
/// Finalize array of srv/RequestCharge messages.
/**
 * It calls
 * uav_msgs__srv__RequestCharge_Request__fini()
...
/// Create array of srv/RequestCharge messages.
/**
 * It allocates the memory for the array and calls
 * uav_msgs__srv__RequestCharge_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RequestCharge messages.
/**
 * It calls
 * uav_msgs__srv__RequestCharge_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RequestCharge message array equality.
/**
...
/// Copy an array of srv/RequestCharge messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * uav_msgs__srv__RequestCharge_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_uav_msgs
...
/**
 * It calls
 * uav_msgs__srv__RequestCharge_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_uav_msgs
...
/**
 * It allocates the memory for the array and calls
 * uav_msgs__srv__RequestCharge_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_uav_msgs
...
/**
 * It calls
 * uav_msgs__srv__RequestCharge_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UAV_MSGS__SRV__DETAIL__REQUEST_CHARGE__FUNCTIONS_H_
